...
public class TestPart1 extends TestCoursework {
  ...
  /**
   * Test class for {@link bugs.ConcurrentModificationBugs}'s signature.
   *
   * @author htson
   * @version 1.0
  ...
  /**
   * Test class for {@link bugs.ConcurrentModificationBugs}'s specification.
   *
   * @author htson
   * @version 1.0
   * @see TestCoursework.AbstractTestConcurrentModificationBug
  ...
  /**
   * Test class for {@link bugs.NoneTerminationBugs}'s signature.
   *
   * @author htson
   * @version 1.0
  ...
  /**
   * Test class for {@link bugs.NoneTerminationBugs}'s specification.
   *
   * @author htson
   * @version 1.0
   * @see TestCoursework.AbstractTestNoneTerminationBug
  ...
  /**
   * Test class for {@link bugs.NullPointerBugs}'s signature.
   *
   * @author htson
   * @version 1.0
   * @see TestCoursework.AbstractTestNullPointerBug
  ...
  /**
   * Test class for {@link bugs.NullPointerBugs}'s specification.
   *
   * @author htson
   * @version 1.0
   * @see TestCoursework.AbstractTestNullPointerBug
